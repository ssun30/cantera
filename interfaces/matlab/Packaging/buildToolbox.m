function buildToolbox(arg)
    ...
    uuidFile = fullfile(arg.ctRoot, 'interfaces', 'matlab', 'Packaging', ...
    ...
    % Define output file
    outputFile = fullfile(arg.ctRoot, 'interfaces', 'matlab', 'Packaging', ...
    ...
    destTutorialDir = fullfile(tmpDir, 'samples', 'tutorials');
    ...
    excludeDirs = {
        fullfile(tmpDir, 'toolbox', 'Packaging')
    ...
    excludeFiles = {
                    fullfile(tmpDir, 'samples', 'tutorials', '*.m'),
                    fullfile(tmpDir, 'toolbox', 'README.md'),
    };
    delete(excludeFiles{:});
